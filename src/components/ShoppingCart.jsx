        ...
        {cartItems.length !==0 && (
         ...
         border-red-200 rounded-tl-lg ${isOpen ? 'right-0' : '-right-[300px]'}`}>
            ...
            <div className='w-full h-16 bg-white relative
                ...
                <button className='w-9 h-9 bg-yellow-400 absolute right-3
            ...
            <button className='w-9 h-9 bg-yellow-400 absolute -left-14 top-3 z-20 
                grid place-items-center border-2 rounded-full' onClick={()=>setIsOpen(true)}>
